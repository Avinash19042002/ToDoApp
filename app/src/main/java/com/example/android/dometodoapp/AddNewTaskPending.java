...
public class AddNewTaskPending extends BottomSheetDialogFragment {
    private static final String TAG = "AddNewTaskPending";
    ...
    private String id="";
    public static AddNewTaskPending newInstance(){
        return new AddNewTaskPending();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.add_new_task_pending,container,false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        mTaskEdit = (EditText)view.findViewById(R.id.task_edit_pending);
        mVoiceType=(TextView)view.findViewById(R.id.voice_type_pending);
        mSave=(TextView)view.findViewById(R.id.save_task_pending);
        msetDue=(TextView)view.findViewById(R.id.set_due_pending);
        mCancel=(TextView)view.findViewById(R.id.cancel_task_pending);
