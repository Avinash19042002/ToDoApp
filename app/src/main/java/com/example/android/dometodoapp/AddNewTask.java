         ...
         public void onClick(View v) {
           ...
           Toast.makeText(context,"Task Updated",Toast.LENGTH_LONG).show();
                 ...
                 if (task.isEmpty()) {
                     ...
                     //   it is for table of All Task Activity
//                     firebaseFirestore.collection("All Tasks").add(taskMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
//                         @Override
//                         public void onComplete(@NonNull Task<DocumentReference> task) {
//                             if (task.isSuccessful()) {
//                                 //    Toast.makeText(context,"Task Saved to All Tasks",Toast.LENGTH_LONG).show();
//                             } else {
//                                 Toast.makeText(context, task.getException().getMessage(), Toast.LENGTH_LONG).show();
//                             }
//                         }
...
//                             });
                     ...
                     //    it is for table of All Task Activity
//                     firebaseFirestore.collection("Pendings").add(taskMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
//                         @Override
//                         public void onComplete(@NonNull Task<DocumentReference> task) {
//                             if (task.isSuccessful()) {
//                                 //    Toast.makeText(context,"Task Saved to All Tasks",Toast.LENGTH_LONG).show();
